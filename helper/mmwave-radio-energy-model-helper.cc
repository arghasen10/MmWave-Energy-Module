...
void 
MmWaveRadioEnergyModelHelper::Set (std::string name, const AttributeValue &v)
{
                                            ...
                                            Ptr<EnergySource> source) const
{
    ...
    if (deviceName.compare ("ns3::MmWaveUeNetDevice") != 0 || deviceName.compare ("ns3::McUeNetDevice")!=0)
    {
        NS_FATAL_ERROR ("Net Device type is not MmWaveUeNetDevice or McUeNetDevice!");
    }
